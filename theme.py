...
[data-testid="stAppViewContainer"], [data-testid="stApp"] {
    background:
        radial-gradient(650px circle at 8% 12%,  rgba(130,170,255,0.28), transparent 60%),
        radial-gradient(550px circle at 92% 8%,   rgba(190,150,255,0.26), transparent 60%),
        radial-gradient(700px circle at 88% 92%,  rgba(150,180,255,0.24), transparent 60%),
        radial-gradient(550px circle at 6% 90%,   rgba(200,165,255,0.22), transparent 60%),
        linear-gradient(135deg, #eef4ff 0%, #f5f0ff 48%, #ffffff 100%);
...
@keyframes bg-drift {
    ...
    100% { background-position: 4% 4%, 96% 3%, 96% 96%, 4% 96%, 0 0; }
}
[data-testid="stHeader"] { background: transparent; }

/* ============ Illustration giáo dục nổi nhẹ - tự ẩn trên di động ============ */
.edu-decor { position: fixed; z-index: 0; pointer-events: none; opacity: 0.15; }
.edu-decor svg { display: block; filter: drop-shadow(0 6px 10px rgba(90,100,190,0.15)); }
.edu-decor-book   { top: 8%;   left: 3%;  width: 66px; animation: edu-float 7s ease-in-out infinite; }
.edu-decor-pencil { top: 66%;  left: 4%;  width: 58px; animation: edu-float 8s ease-in-out infinite 0.6s; }
.edu-decor-cap    { top: 9%;   right: 4%; width: 70px; animation: edu-float 7.5s ease-in-out infinite 0.3s; }
.edu-decor-school { bottom: 6%; right: 5%; width: 86px; animation: edu-float 9s ease-in-out infinite 0.9s; }
@keyframes edu-float {
...
/* ============ Glassmorphism cho form / thẻ nội dung ============ */
div[data-testid="stForm"] {
    ...
    box-shadow: 0 10px 34px rgba(94, 100, 180, 0.14), 0 2px 6px rgba(94, 100, 180, 0.08);
    padding: 1.8em 1.6em;
}
...
.edu-glass-card {
    ...
    box-shadow: 0 10px 30px rgba(94, 100, 180, 0.14);
    padding: 2em 1.6em;
}
...
.section-title {
    background: linear-gradient(90deg, #eaf1ff 0%, #f3ecff 100%) !important;
    border-left: 5px solid #7c6df2 !important;
    box-shadow: 0 2px 10px rgba(124, 109, 242, 0.10);
}
...
div[data-testid="stMetric"] {
    ...
    border-radius: 14px;
    padding: 0.6em 0.8em;
    box-shadow: 0 4px 14px rgba(94, 100, 180, 0.10);
}
</style>
"""
